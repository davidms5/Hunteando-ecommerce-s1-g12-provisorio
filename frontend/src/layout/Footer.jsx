          ...
          <div className="col-12 col-md-6 py-5">
            <div className="footer-redes">
              ...
              <div className="footer-redes__redes">
                <a target="_blank" rel="noopener noreferrer" href="https://api.whatsapp.com/message/2MNYQ5IKKRNVG1?autoload=1&app_absent=0">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/profile.php?id=100076937733899">
